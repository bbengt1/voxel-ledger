/**
 * `/quotes` — list with state filter + URL-state.
 */
...
const STATES = ["draft", "sent", "accepted", "declined", "expired", "cancelled"] as const;
...
export function QuotesListPage() {
  ...
  const [items, setItems] = useState<QuoteResponse[]>([]);
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch((err: unknown) => {
        ...
        setError(typeof detail === "string" ? detail : "Failed to load quotes.");
      })
      .finally(() => {
