...
> **HISTORICAL — v1 era.** `web01-deploy` targets the legacy v1 host. The
> canonical v2 deploy path is `web02-deploy`; see
> [`web02_n8n_deploy.md`](web02_n8n_deploy.md). This document is preserved for
> v1 operations until the legacy host is retired.
