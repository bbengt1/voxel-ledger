"""Debit note posts debit AR / credit Revenue + raises outstanding (Phase 7.4, #112)."""
...
@pytest.mark.asyncio
async def test_issue_debit_note_posts_debit_ar_credit_revenue(
    ...
    assert by_acct[accounts["ar_account_id"]].debit == Decimal("15.000000")
    assert by_acct[accounts["revenue_account_id"]].credit == Decimal("15.000000")
