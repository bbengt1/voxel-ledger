...
class InvoiceItem(Base):
    ...
    # Phase 9.5 (#157): per-line tax-profile override + the per-line
    # computed tax. ``tax_amount`` is recomputed at draft save and
    # finalized at issue time; aggregated up to ``invoice.tax_amount``.
